...
(function() {
    ...
    if (typeof loadExerciseModule === 'function') {
        loadExerciseModule('assistanceLower', assistanceLower);
    } else {
        console.error('loadExerciseModule function not available when loading assistanceLower');
    }
})();
